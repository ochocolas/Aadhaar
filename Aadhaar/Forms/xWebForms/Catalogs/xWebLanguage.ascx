<%@ Control Language="C#" AutoEventWireup="true" CodeFile="xWebLanguage.ascx.cs" Inherits="Forms_xWebForms_Catalogs_xWebLanguage" %>
...
<dx:ASPxLabel ID="lblTitulo" runat="server" Font-Bold="True" Font-Size="XX-Large" Font-Strikeout="False" Font-Underline="False" Text="Language">
</dx:ASPxLabel>
<dx:ASPxGridView ID="ASPxGridViewLanguage" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSourceLanguage" KeyFieldName="Id" OnCustomErrorText="ASPxGridViewLanguage_CustomErrorText">
...
<asp:ObjectDataSource ID="ObjectDataSourceLanguage" runat="server" DataObjectTypeName="AadhaarFramework.Code.Data.Entity.People.Language" DeleteMethod="Delete" InsertMethod="Save" SelectMethod="GetAll" TypeName="AadhaarFramework.Code.Data.Providers.People.LanguageProvider" UpdateMethod="Save"></asp:ObjectDataSource>
