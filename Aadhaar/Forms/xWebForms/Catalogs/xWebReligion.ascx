<%@ Control Language="C#" AutoEventWireup="true" CodeFile="xWebReligion.ascx.cs" Inherits="Forms_xWebForms_Catalogs_xWebReligion" %>
...
<dx:ASPxLabel ID="lblTitulo" runat="server" Font-Bold="True" Font-Size="XX-Large" Font-Strikeout="False" Font-Underline="False" Text="Religion">
</dx:ASPxLabel>
<dx:ASPxGridView ID="ASPxGridViewReligion" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSourceReligion" KeyFieldName="Id" OnCustomErrorText="ASPxGridViewReligion_CustomErrorText">
...
<asp:ObjectDataSource ID="ObjectDataSourceReligion" runat="server" DataObjectTypeName="AadhaarFramework.Code.Data.Entity.People.Religion" DeleteMethod="Delete" InsertMethod="Save" SelectMethod="GetAll" TypeName="AadhaarFramework.Code.Data.Providers.People.ReligionProvider" UpdateMethod="Save"></asp:ObjectDataSource>
