<%@ Control Language="C#" AutoEventWireup="true" CodeFile="xWebCountryZone.ascx.cs" Inherits="Forms_xWebForms_Catalogs_xWebCountryZone" %>
...
<dx:ASPxLabel ID="lblTitulo" runat="server" Font-Bold="True" Font-Size="XX-Large" Font-Strikeout="False" Font-Underline="False" Text="Country zone">
</dx:ASPxLabel>

<dx:ASPxGridView ID="ASPxGridViewCountryZone" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSourceCountryZone" KeyFieldName="Id" OnCustomErrorText="ASPxGridViewCountryZone_CustomErrorText">
...
<asp:ObjectDataSource ID="ObjectDataSourceCountryZone" runat="server" DataObjectTypeName="AadhaarFramework.Code.Data.Entity.People.CountryZone" DeleteMethod="Delete" InsertMethod="Save" SelectMethod="GetAll" TypeName="AadhaarFramework.Code.Data.Providers.People.CountryZoneProvider" UpdateMethod="Save"></asp:ObjectDataSource>
